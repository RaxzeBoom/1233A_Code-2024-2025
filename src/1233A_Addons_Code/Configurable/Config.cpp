...
int DriverScoreMidSpeed[3] = {127,127,127};
...
pros::controller_digital_e_t MiddleRollerFwdButton = pros::E_CONTROLLER_DIGITAL_R2;
pros::controller_digital_e_t MiddleRollerRevButton = pros::E_CONTROLLER_DIGITAL_R1;
