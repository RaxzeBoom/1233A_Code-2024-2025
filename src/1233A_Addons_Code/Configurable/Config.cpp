...
pros::controller_digital_e_t FrontRollerFwdButton = pros::E_CONTROLLER_DIGITAL_L1;
pros::controller_digital_e_t FrontRollerRevButton = pros::E_CONTROLLER_DIGITAL_L2;
